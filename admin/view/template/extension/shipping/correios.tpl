    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
		...
		<div class="table-responsive">
			<h4>Conheça outros módulos que pode lhe interessar:</h4>
			<div style="width: 50%; float: left">
				<ul>
					<li><a href="https://www.julioguimaraes.com/opencart/modulo-correios" target="_blank">Versão completa do módulo dos Correios</a></li>
					<li><a href="https://www.julioguimaraes.com/opencart/modulo-calculo-frete-na-pagina-do-produto" target="_blank">Cálculo de Frete na Página do Produto</a></li>
					<li><a href="https://www.julioguimaraes.com/opencart/pagseguro" target="_blank">Forma de Pagamento PagSeguro com Lightbox</a></li>
					<li><a href="https://www.julioguimaraes.com/opencart/tabela-parcelas-pagseguro" target="_blank">Tabela de Parcelas do PagSeguro</a></li>
					<li><a href="https://www.julioguimaraes.com/opencart/desconto-por-forma-de-pagamento" target="_blank">Desconto por Forma de Pagamento</a></li>				
					<li><a href="https://www.julioguimaraes.com/opencart/comprar-junto" target="_blank">Módulo Comprar Junto</a></li>
					<li><a href="https://www.julioguimaraes.com/opencart/acessorios-de-produto" target="_blank">Acessórios para Produto</a></li>
				</ul>
			</div>
			<div style="width: 50%; float: left">
				<a href="https://www.julioguimaraes.com/opencart/" target="_blank"><img src="view/template/extension/shipping/opencart-logo-by-julio-orange-370x86.png" /></a>
			</div>			<table id="servicos" class="table table-striped table-bordered table-hover">
			  <thead>
				<tr>
			  ...
			  <tfoot>
				<tr>
				  <td colspan="20" class="text-right"><button type="button" onclick="addServico();" data-toggle="tooltip" title="<?php echo $button_add_servico; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
				</tr>
			  </tfoot>
			</table>
		  </div>
...
function addServico() {
	html  = '<tr id="servico-row' + servico_row + '">';
	  ...
	  html += '  <td class="text-left"><input type="text" name="correios_servicos[' + servico_row  + '][adicional_manuseio]" value="20.00" class="form-control" style="width:50px" /></td>';
