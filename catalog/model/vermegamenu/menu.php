...
//        $html[] = '</a>';
        ...
        if ($drawPopup) {
            ...
            $html[] = '<div class="wrap-popup"><div id="v_popup' . $id . '" class="popup cmsblock" style="display: none; width: 904px;"><div class="arrow-left-menu"></div>';
            if ($blockHtml) {
	...
	public function drawCustomMenuItem($category, $level = 0, $last = false, $item, $lang_id,$setting = array()) {
        ...
        if ($drawPopup) {
            if ($this->_show_level >= 2) {
                // --- Popup function for hide ---
                $html[] = '<div class="wrap-popup"><div id="v_popup' . $id . '" class="popup" style="display: none; width:815px"><div class="content-popup"><div class="arrow-left-menu"></div>';
                // --- draw Sub Categories ---
                 if (count($activeChildren) || $blockHtml) {
					//echo "<pre>"; print_r($blockHtml); echo "</pre>"; 
                    $html[] = '<div class="block1" id="v_block1' . $id . '">';
