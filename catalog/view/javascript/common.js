...
function customResponsive(){
	...
	if(window_w <= 991){
		$('.group1 .main-menu').prependTo($('.group1 .bottom-header .container .row'));
		$('.group1 .search-containers').before($('.group1 .cart-container'));
		$('.group2 .search-containers').before($('.group2 .cart-container'));		
	} else {
		$('.group1 .logo-container').after($('.group1 .main-menu'));
		$('.group1 .vermagemenu-container').after($('.group1 .search-containers'));
		$('.group2 .cart-container').before($('.home2 .search-containers'));		
	}
	if(window_w <= 1400){
		$('.home3 .occountdown_module').before($('.home3 .static-policy'));
	} else {
		$('.home3 .main-menu .cms-description').append($('.home3 .static-policy'));
	}
}
...
function stickyMenu(){
	...
	var headerSpaceH = $('.hozmenu-container').outerHeight(true);
	var scroll = $(window).scrollTop();
	var currentP = 0;
	
	$('.headerSpace').remove();	
	$('.hozmenu-container').after('<div class="headerSpace unvisible" style="height: '+headerSpaceH+'px;" ></div>');	
	if(scroll != currentP){
		if(winInnW>1024){
			if(winScrT>300){
				$('.hozmenu-container').addClass('fix-header');			
				$('.headerSpace').removeClass('unvisible');
			} else{
				$('.hozmenu-container').removeClass('fix-header');
...
$(document).ready(function() {	
	...
	$('.hozmenu-container').hover(function(){ 
	...
	// move breadcrumbs
	$('.bottom-header').after('<div class="breadcrumbs"><div class="container"></div></div>');	
