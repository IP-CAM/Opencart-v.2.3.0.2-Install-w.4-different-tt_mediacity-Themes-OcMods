		...
		<div class="col-2 col-sm-7">
		  ...
		  <?php if ($price) { ?>
			  <ul class="list-unstyled price-product">
				...
				<?php } else { ?>
				<li><span class="old-price"><?php echo $price; ?></span><span class="new-price"><?php echo $special; ?></span></li>
				<?php } ?>
			  </ul>
			  <?php } ?>
		  ...
		  <div class="form-group">
				...
				<button class="button" type="button" id="button-cart2" data-loading-text="<?php echo $text_loading; ?>"><i class="fa fa-shopping-bag"></i><span><?php echo $button_cart; ?></span></button>
				<div class="clearfix"></div>
				<button class="btn-wishlist button" type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="addWishlist('<?php echo $product_id; ?>');"><i class="fa fa-heart-o"></i><span><?php echo $button_wishlist; ?></span></button>
				<button class="btn-compare button" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="addCompare('<?php echo $product_id; ?>');"><i class="fa fa-compress"></i><span><?php echo $button_compare; ?></button>
			</div> 		  			  
