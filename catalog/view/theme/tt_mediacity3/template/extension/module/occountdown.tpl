...
<?php if($products): ?>
    ...
    <?php  if($count % $rows == 0 ) { echo '<div class="row_items">'; } $count++; ?>
            <div class="product-layout product-grid">
					...
					<?php } ?>
					<div class="product-des"><?php echo $product['description3']; ?></div>
					<div class="product-intro">
						<div class="actions-link2">	
							<a class="btn-cart" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');">
								<span class="button"><?php echo $button_cart; ?></span>
							</a>
						</div>						
					</div>
