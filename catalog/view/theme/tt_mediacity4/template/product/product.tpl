        ...
        <div class="col-2 col-sm-7">
		  ...
		  <p class="short-des">
			  ...
			  <div class="form-group">
				...
				<button class="button" type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>"><i class="fa fa-shopping-bag"></i><span><?php echo $button_cart; ?></span></button>
				<div class="clearfix"></div>
				<button class="button btn-wishlist" type="button" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart-o"></i><span><?php echo $button_wishlist; ?></span></button>
				<button class="button btn-compare" type="button" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-compress"></i><span><?php echo $button_compare; ?></span></button>
			</div>
